<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsContent.aspx.cs" Inherits="InformationServices.NewsContent" %>
...
<div id="container">
	...
	<div id="content" style="background-color:#ffffff;">
            ...
            <tr><td align="left"><span id="StyleName" runat="server">协会名称</span></td></tr>
            <tr class="line" style="height:1px; width:673px"><td><hr></td></tr>
            </table>
            </div>
			<div>
              <table border="0" cellpadding="0" cellspacing="0" style=" position:relative; width:99%;height:100%; table-layout: fixed;
word-wrap:break-word;">
              <tr  valign="top"><td>
              <h3 style="text-align:center;"><span id="ArticleTitle" runat="server">标题</span></h3>
              <p style="text-indent: 2em"><span id="ArticleContent" runat="server">内容</span></p>
              <p style=" text-align:right;"><span id="ArticleEnd" runat="server" >结尾</span></p></td></tr>
              </table>
            </div>
	</div>
    <!--子版块2-->
...
<%--        <div><img src="/images/ad1.png" alt="电子商务协会"/>
            ...
            style=" position:relative; margin-top:20px; margin-bottom:10px; left: 0px; top: 0px;">
                    <tr><td><img src="/images/ad1.png" alt="电子商务协会"/></td><td>电子商务协会<br />
                        <br />
